...
export class NoticiasService {
  ...
  getNoticias() : Noticia[] {
    ...
    return [
      ...
      {"id":5,
        "titulo":"Rocket League estará presente en LUGO GAMING FEST",
        "subtitulo":"Goles, explosiones y vuelos en LUGO GAMING FEST de la mano de Rocket League",
        "url_imagen":"./assets/imagenes_noticias/RL_LGF.jpg",
        "categoria" : [this.categoriasService.getCategoriaById(2)],
        "contenido":"<br><ul><li>DualView y DfreezeGirl serán los embajadores de la competición.</li><li>Se repartirán 800€ entre los equipos ganadores.</li><li>Contará con la presencia de dos casters de lujo: Koala y Faitti.</li></ul><br><p>LUGO GAMING FEST calienta motores acercando el mundo de los videojuegos y los deportes electrónicos a la ciudad gallega. El <strong>crecimiento del sector</strong> parece no tener fin y, como era de esperar, Lugo se suma a esta vorágine de puntos de encuentro para la comunidad gamer.</p><p>Este evento reunirá una amplia cantidad de actividades y contará con el apoyo de creadores de contenido. Dos de ellos, <strong>DualView y DfreezeGirl</strong> protagonizarán la sección de Rocket League en el festival. Amenizarán la competición ofreciendo un Showmatch que se realizará en el escenario antes de la final.</p><br><p>LUGO GAMING FEST será el broche de oro de la competición online del alocado título de Psyonix. Dividida en dos clasificatorios, estos Brackets se celebraron de manera online y dieron a conocer a dos equipos ganadores. <strong>Darkcasts </strong> y <strong>Howl Esports</strong> se verán las caras en Lugo para demostrar cuál de ambas escuadras es mejor con las físicas y la geometría en el terreno de juego.</p><br><ul><li><strong>Jugadores DarkCats</strong>: Jrdi, Marc y SirG</li><li><strong>Jugadores Howl</strong>: Lxriks, Hakuru_Peluche y OrkanZ</li></ul><br><p>El enfrentamiento, que se jugará a <strong>Bo7</strong>, coronará al campeón de esta primera edición y contará con un montante de <strong>800€</strong> que se repartirán entre ambos equipos (550 para el primero y 250 para el segundo) </p><p>Por otro lado, la gala quedará amenizada con un <strong>Showmatch</strong> protagonizado por <strong>DualView</strong> y <strong>DfreezeGirl</strong>. Serán los capitanes de este divertido enfrentamiento que se realizará justo antes de la final. El partido será un <strong>Bo5</strong> y sus equipos estarán compuestos por streamers y jugadores amateurs de la comunidad de Rocket League. Además, todo se retransmitirá en directo para aquellas que aquellas personas que no puedan acudir al evento presencialmente lo puedan ver desde casa.</p><p>Finalmente, esta contienda de Rocket League en Lugo tendrá a dos de los mejores casters del panorama español del título de Psyonix. <strong>Koala y Faitti</strong> serán los encargados de ponerle voz a los enfrentamientos aportando su especial toque a los choques.</p>",
        "fx_publicacion_fx":"2022/03/29"
      }
